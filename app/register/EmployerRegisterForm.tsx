    ...
    <div className="bg-gradient-to-br flex items-center justify-center ">
      ...
      >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="relative">
              ...
              <Input
                ...
                required
                className="pl-14 h-14 border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded"
        ...
        <section className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="relative">
              <Building className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 h-6 w-6" />
              <Input
                id="companyName"
            ...
            >
              <SelectTrigger className="h-14 border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded">
                <SelectValue placeholder="Type d'établissement" />
              </SelectTrigger>
              <SelectContent>
                {companyTypes.map((type: string) => (
                  <SelectItem key={type} value={type} className="text">
                    {type}
                  </SelectItem>
                ))}
              </SelectContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="relative">
              <Input
                ...
                required
                className="pr-12 pl-6 h-14 border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded"
            ...
            <Input
              ...
              required
              className="h-14 border-gray-300 focus:border-blue-500 focus:ring-blue-500 rounded"
